...
<head>
	...
	<title>File Manage &raquo; Corporate Alliance</title>
												...
												if(mysqli_num_rows($result) > 0){
													...
													while($row = mysqli_fetch_array($result)){
														echo "<tr>";
															...
															echo '<td><a href="files-download.php?file-id=' . $row['id'] . '&fileUrl='. $row['url'] . '"><button type="button">Download</button></a></td>';
														echo "</tr>";
													}
													echo "</table>";
													// Free result set
